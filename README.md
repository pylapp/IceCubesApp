...
> - `Fix missing color of icons for destructive actions (report and delete toot)` ([#2467](https://github.com/Dimillian/IceCubesApp/pull/2467))
> - `Add missing french translations for at least toot toast publications` ([#2465](https://github.com/Dimillian/IceCubesApp/pull/2465))
> - `Fix plural form for header of pinned toots` ([#2464](https://github.com/Dimillian/IceCubesApp/pull/2464))
